...
const CITAZIONE_CIVILE_RULES: EventRule[] = [
  ...
  // ── CONVENUTO: Costituzione convenuto 70 gg prima della prima udienza ──
  {
    macroArea: "CIVILE_CONTENZIOSO",
    procedimento: "CITAZIONE_CIVILE",
  ...
  },
  {
    ...
    norma: "Art. 171-ter c.p.c.",
    noteOperative:
      "Prova contraria e indicazioni istruttorie conseguenti (data prima udienza o slittamento data prima udienza).",
    ordine: 7,
  },
  {
    macroArea: "CIVILE_CONTENZIOSO",
  ...
  },
  {
    ...
    procedimento: "CITAZIONE_CIVILE",
    parteProcessuale: "COMUNE",
    eventoBaseKey: "dataProvvedimentoNotePrecisazioneCitazione",
  ...
  },
  {
    ...
    procedimento: "CITAZIONE_CIVILE",
    parteProcessuale: "COMUNE",
    eventoBaseKey: "dataProvvedimentoAssegnazioneTerminiCitazione",
...
const RICORSO_RITO_SEMPLIFICATO_ROWS: ExcelRuleRow[] = [
  ...
  },
  {
    ...
    eventoBaseKey: "dataProvvedimentoTerminiRitoSemplificato",
    direzioneCalcolo: null,
    numero: null,
    unita: null,
    tipoTermine: "da_parametrizzare",
  ...
  },
  {
    ...
    eventoBaseKey: "dataDepositoSentenzaRicorso",
    direzioneCalcolo: "+",
    numero: 6,
    unita: "mesi",
    tipoTermine: "perentorio",
  ...
  },
  {
    ...
    eventoBaseKey: "dataNotificaSentenzaRicorso",
    direzioneCalcolo: "+",
    numero: 30,
    unita: "giorni",
    tipoTermine: "perentorio",
...
const APPELLO_CIVILE_RULES: EventRule[] = [
  ...
  },
  {
    ...
    procedimento: "APPELLO_CIVILE",
    parteProcessuale: "COMUNE",
    eventoBaseKey: "dataNotificaSentenzaAppelloCivile",
    eventoLabel:
      "Notifica Sentenza (per calcolare termini Ric Cassazione)",
    direzioneCalcolo: "+",
    numero: 60,
    unita: "giorni",
    tipoTermine: "perentorio",
