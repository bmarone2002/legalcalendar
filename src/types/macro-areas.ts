...
export const EVENTI_PER_PROCEDIMENTO: Partial<Record<ProcedimentoCode, EventoDisponibile[]>> = {
  ...
  DECRETO_INGIUNTIVO: [
    ...
    {
      code: "NOTIFICA_ATTO_OPPOSIZIONE_AL_RICORRENTE_DI",
    ...
    },
    {
      ...
      label: "Costituzione Opposto",
      inputKey: "dataPrimaUdienzaOpposizioneDI",
      parteProcessuale: "CONVENUTO",
      ordine: 8,
    },
    {
      code: "COSTITUZIONE_OPPOSTO_DI_ATTORE",
      label: "Costituzione Opposto",
      inputKey: "dataPrimaUdienzaOpposizioneDI",
      parteProcessuale: "ATTORE",
      ordine: 8,
    ...
    {
      code: "MEMORIA_171TER_OPPO_DI_1",
      label: "Memorie 171-ter c.p.c. I",
      inputKey: "dataPrimaUdienzaOpposizioneDI",
      parteProcessuale: "COMUNE",
      ordine: 10,
    },
    {
      code: "MEMORIA_171TER_OPPO_DI_2",
      label: "Memorie 171-ter c.p.c. II",
      inputKey: "dataPrimaUdienzaOpposizioneDI",
      parteProcessuale: "COMUNE",
      ordine: 11,
    },
    {
      code: "MEMORIA_171TER_OPPO_DI_3",
      label: "Memorie 171-ter c.p.c. III",
      inputKey: "dataPrimaUdienzaOpposizioneDI",
      parteProcessuale: "COMUNE",
      ordine: 12,
    },
